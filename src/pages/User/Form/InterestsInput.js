  ...
  return (
    <div className='flex flex-col items-center xl:items-start'>
      ...
      <div className='relative w-full mt-1'>
        <input
          className='rounded-none text-center xl:text-left pr-10 w-full py-1 border-b border-gray-500 sm:text-sm text-gray-900 bg-transparent focus:outline-none focus:border-gray-900'
          type='text'
          value={input}
